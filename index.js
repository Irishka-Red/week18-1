...
const element1 = document.querySelector('.button-primary.b-1');
function makeOne() {
	localStorage.setItem('games', '11');
	console.log('ключ games записан со значением 11 в Local Storage.');
}
...
document.querySelector('.button-primary.b-2').addEventListener('click', makeTwo);
...
function makeThree() {
	localStorage.setItem('string2', 'name=John, age=25');
...
function makeFour() {
	localStorage.setItem('meaning', 'true');
	console.log('Логическое значение true было записано в Local Storage.');
}

document.querySelector('.button-primary.b-4').addEventListener('click', makeFour);
...
function makeFive() {
	localStorage.setItem('meaning5', 'null');
	console.log('Значение null было записано в Local Storage.');
}

document.querySelector('.button-primary.b-5').addEventListener('click', makeFive);
...
document.querySelector('.button-primary.b-6').addEventListener('click', makeSix);
...
document.querySelector('.button-primary.b-7').addEventListener('click', makeSeven);
...
document.querySelector('.button-primary.b-8').addEventListener('click', makeEight);
...
document.querySelector('.button-primary.b-9').addEventListener('click', makeNine);
...
document.querySelector('.button-primary.b-10').addEventListener('click', makeTen);
...
document.querySelector('.button-primary.b-11').addEventListener('click', makeEleven);
...
document.querySelector('.button-primary.b-12').addEventListener('click', showEleven);
...
document.querySelector('.button-primary.b-13').addEventListener('click', showTen);
...
document.querySelector('.button-primary.b-14').addEventListener('click', showNine);
...
const removeFromCart = () => {
	...
	if (cartItems && cartItems.length > 0) {
		...
		console.log('Последний элемент был удален из массива carsItems и сохранен в локальном хранилище.');
} else {
  console.log('Массив carsItems пуст или не существует в локальном хранилище.');
}
};
...
const showCart = () => {
	let cartItems = JSON.parse(localStorage.getItem("cartItems"));
	let outputElement = document.querySelector(".practicum23");
	outputElement.innerHTML = "";
	if (cartItems && carsItems.length > 0) {
		cartItems.forEach((element) => {
		  let paragraph = document.createElement("p");
		  paragraph.textContent = cartItems;
		  outputElement.appendChild(paragraph);
			});
		  } else {
			outputElement.textContent = "Массив пуст.";
		  }
};
...
const updateCartCount = () => {
	let cartItems = JSON.parse(localStorage.getItem("cartItems"));
	let outputElement = document.querySelector(".practicum24");
	outputElement.innerHTML = "";
	if (cartItems && cartItems.length > 0) {
		let paragraph = document.createElement("p");
		paragraph.textContent = "Количество товаров в корзине: " + cartItems.length;
		outputElement.appendChild(paragraph);
	} else {
	  outputElement.textContent = "Корзина пуста.";
	}
};
...
const checkCookie = () => {
	...
	if (username !== '') {
		...
		console.log("Файл cookie с именем «имя пользователя» не найден.");
	}
};
